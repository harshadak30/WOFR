...
const WofrLeaseIntroPage: React.FC = () => {
    return (
        <MainLayout>
            <div>
                {/* Navbar */}
                ...
                <div className="flex flex-col lg:flex-row flex-wrap items-center justify-between mx-8 px-4  min-h-screen">
                    {/* Left Section - Text Content */}
                    <div className="w-full lg:w-2/3 xl:w-1/4 max-w-3xl text-left mb-1 lg:mb-0">
                        ...
                        <p className="text-gray-600 mt-4 text-lg lg:text-xl xl:text-2xl">
                            Simplify property management, automate rent collection, and maintain
                            complete oversight of your lease portfolio with our comprehensive
                    ...
                    {/* Right Section - Image */}
                    <div className="w-full lg:w-1/3 xl:w-3/4 flex justify-center h-[76%]">
                        <img src="/background/wofrLeaseIntroPage.png" 
...
export default WofrLeaseIntroPage;
