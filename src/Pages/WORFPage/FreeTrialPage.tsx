...
//           <div className="relative max-w-7xl mx-auto px-2 sm:px-6 lg:px-8 pt-14 pb-10">
//             <h1 className="text-4xl lg:text-5xl font-bold mb-16 text-black text-center animate-fade-in">
//               Start a 7 day trial for free
//             </h1>
            
//             <div className="flex flex-col-reverse lg:flex-row lg:items-start lg:justify-between gap-1 mt-24">
//               <div className="w-full lg:w-[35%] mt-8 lg:mt-0 animate-fade-in ">
