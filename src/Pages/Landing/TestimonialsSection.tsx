      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-6 nx-5">
        ...
        <div className="bg-gray-50 rounded-3xl px-6 md:px-10 pt-8 md:pt-10 m-2 md:m-5">
                <div className="flex items-start mb-4">
                  <img src={icons.phone} alt="phone" className="w-10 h-10 md:w-14 md:h-14" />
                </div>
              ...
              <div className="bg-gray-50 rounded-3xl p-6 md:p-10 m-2 md:m-5">
                <div className="flex items-start mb-4">
                  <img src={icons.graph} alt="graph" className="w-10 h-10 md:w-14 md:h-14" />
                </div>
  ...
  <div className="mt-6 flex flex-col lg:flex-row">
    ...
    <div className="w-full lg:w-[60%] relative">
      ...
      <div className="flex flex-row justify-between absolute top-0 w-full px-2 sm:px-5">
        ...
        <div className={`w-1/2 transform transition-all duration-700 ease-out ${headerVisible ? 'translate-x-0 opacity-100' : '-translate-x-20 opacity-0'}
                       lg:absolute lg:-top-20 lg:left-20 lg:w-2/4`}>
          <img
            src={backgroundImages.featureHeader}
            alt="Feature Visualization"
            className="w-full transition-transform duration-300 hover:scale-110"
        ...
        <div className={`w-1/3 transform transition-all duration-700 ease-out ${flagVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}
...
<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8 mt-10 px-4 sm:px-6 lg:px-0">
  ...
  <div className="bg-gray-50 rounded-3xl p-6 sm:p-8 lg:p-10 relative h-96 sm:h-100 lg:h-120 overflow-hidden">
    <img src={icons.phone2} alt="Phone" className="w-10 h-10 sm:w-12 sm:h-12 lg:w-14 lg:h-14 mb-4" />
  ...
  <motion.div
    ...
    whileTap={{ y: -5 }}
  >
    <img src={icons.list} alt="List Icon" className="w-10 h-10 sm:w-12 sm:h-12 lg:w-14 lg:h-14 mb-4" />
    <h3 className="text-2xl sm:text-3xl lg:text-4xl font-semibold mb-4 z-10 relative">
      Subscriptions you control in one place
    </h3>
    <img
      src={backgroundImages.featureStepThree}
