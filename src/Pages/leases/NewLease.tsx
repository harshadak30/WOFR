      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="mt-1 text-gray-500">
            Complete the form to create a new lease agreement.
          </p>
        </div>
      </div>
          ...
          <div className="flex mb-6">
            ...
            <div
              className={`flex-1 p-4 text-center ${
                step >= 4 ? "text-primary-600" : "text-gray-400"
              }`}
            >
              <div className="flex justify-center mb-2">
                <div
              ...
              {step === 1 && (
                ...
                >
                  ...
                  <div className="flex justify-end">
                    <button onClick={nextStep}>Next: Client Information</button>
                  </div>
                </motion.div>
              )}
              ...
              {step === 2 && (
                ...
                >
                  ...
                  <div className="flex justify-between">
                    ...
                    <button onClick={nextStep}>Next: Financial Terms</button>
                  </div>
                </motion.div>
              )}
                ...
                >
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-2 text-sm">
                        <div className="flex justify-between md:block">
                          ...
                          <span className="md:ml-2 font-medium">
                            {formData.leaseTitle || "Not provided"}
                          </span>
                        </div>
                        <div className="flex justify-between md:block">
                          <span className="text-gray-500">Lease Type:</span>
                          <span className="md:ml-2 font-medium capitalize">
                            {formData.leaseType || "Not provided"}
                          </span>
                        </div>
                    ...
                    <div className="border-t border-gray-200 pt-4">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-2 text-sm">
                        ...
                        <div className="flex justify-between md:block">
                          ...
                          <span className="md:ml-2 font-medium capitalize">
                            {formData.clientType || "Not provided"}
                          </span>
                        </div>
                        <div className="flex justify-between md:block">
                    ...
                    <div className="border-t border-gray-200 pt-4">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-2 text-sm">
                        ...
                        <div className="flex justify-between md:block">
                          ...
                          <span className="md:ml-2 font-medium capitalize">
                            {formData.paymentFrequency || "Not provided"}
                          </span>
                        </div>
                        <div className="flex justify-between md:block">
                          <span className="text-gray-500">
                  ...
                  <div className="flex items-center">
                    ...
                    >
                      ...
                      complete. By submitting this form, I authorize the
                      creation of this lease agreement.
                    </label>
                  </div>
